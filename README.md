...
* [get_count](docs/sdks/nodes/README.md#get_count) - Retrieve a count of Worker and Edge Nodes
...
* [update_pipeline_by_id](docs/sdks/pipelines/README.md#update_pipeline_by_id) - Update a Pipeline
...
* [create_hec_token](docs/sdks/sources/README.md#create_hec_token) - Add an HEC token and optional metadata to a Splunk HEC Source
* [update_hec_token_metadata](docs/sdks/sources/README.md#update_hec_token_metadata) - Update metadata for an HEC token for a Splunk HEC Source
...
* [clean_working_dir](docs/sdks/versioning/README.md#clean_working_dir) - Undo the most recent commit and restore the local repository to the previous commit
